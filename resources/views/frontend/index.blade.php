...
@section('content')
  <!-- Hero/Intro Slider Start -->
    ...
    <div class="banner-area pt-100px pb-100px plr-15px">
        <div class="row m-0">
            @foreach ($categories as $category)
            <div class="col-12 col-lg-4 show_more_rabaya">
                <div class="single-banner-2">
                    <img height="300" src="{{ asset('uploads/category_photos')}}/{{ $category->category_photo }} " alt="">
                    <div class="item-disc">
                        <h4 class="title text-white">{{ $category->category_tagline }} <br>
                            {{ $category->category_name }}</h4>
                        <a href="{{ route('categorywise.products', $category->id) }}" class="shop-link btn btn-primary">Shop Now <i
