    ...
    <div id="wrapper">
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo">
                        ...
                        <i>
                            <img src="{{ asset('dashboard') }}/assets/images/logo_sm.png" alt=""
                                height="28">
                        </i>
                    </a>
                </div>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span>Vandor</span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('vendor.create') }}">Add Vandor</a></li>
                                <li><a href="{{ route('vendor.index') }}">List Vandor</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span>Category Menu </span>
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span>Coupon </span>
                                <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="{{ route('location') }}">
                                <i class="fi-command"></i> <span> Location </span>
                            </a>
                        </li>
                        <li>
        ...
        <div class="content-page">
            ...
            <footer class="footer text-right">
                {{ \Carbon\Carbon::today()->format('Y') }} © Highdmin. - Coderthemes.com
            </footer>
