...
<body>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{ totalproductssatcart() }}</span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    @empty
                    <li>
                        <h4><strong>No Product to Show </strong></h4>
                    </li>
                     @endforelse
                </ul>
            </div>
    ...
    <script>
        $(function() {
  $(".show_more_rabaya").slice(0, 4).show();
  $("#loadMore").on('click', function(e) {
    e.preventDefault();
    $(".show_more_rabaya:hidden").slice(0, 4).slideDown();
    if ($(".show_more_rabaya:hidden").length == 0) {
  ...
  $("#loadLess").on('click', function(e) {
    e.preventDefault();
    $('.show_more_rabaya:not(:lt(4))').fadeOut();
