            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content">
                        ...
                        <small>Available Stock: {{ $single_product_info->product_quantity }}</small>
                        ...
                        <p class="mt-30px mb-0">{{ $single_product_info->product_short_desp }}</p>
                        ...
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="{{ route('categorywise.products', $single_product_info->category_id) }}">
                ...
                <div class="tab-content description-review-bottom">
                    ...
                    <div id="des-details1" class="tab-pane active">
                        <div class="product-description-wrapper">
                            <p>
                                {{ $single_product_info->product_long_desp }}
