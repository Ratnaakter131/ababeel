                        ...
                        <div class="table-content table-responsive cart-table-content">
                            <table>
                                ...
                                <tbody>
                                        ...
                                        <td class="product-name"><a href="#">
                                            ...
                                            @if ($cart->amount > available_quantity($cart->product_id))
                                             @php
                                                 $flag= true;
                                             @endphp
                                            <span class="text-primary"> Stock Out</span>
                                              @else
                                             Available
                                            @endif
                                        </a></td>
                                    ...
                                    @empty
                                      <tr>
                                        <td><strong>Your Cart is now empty</strong></td>
                                      </tr>
                                    @endforelse
                                </tbody>
                            </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 mt-md-30px">
                            <div class="grand-totall">
                                ...
                                <h5> Sub Total: (approx.) <span id="sub_total">${{ round($cart_total-$discount_total) }}</span></h5>
